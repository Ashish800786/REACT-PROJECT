                                    ...
                                    <div className="col-md-12">
                                       <div className="content testimonial">
                                          <div id="testimonial_slider" className="carousel slide" data-ride="carousel">
                                             ...
                                             {/* <!-- Carousel controls --> */}
                                             <a className="carousel-control left carousel-control-prev" href="1testimonial_slider" data-slide="prev">
                                             <i className="fa fa-angle-left"></i>
                                             </a>
                                             <a className="carousel-control right carousel-control-next" href="1testimonial_slider" data-slide="next">
                     ...
                     <div className="row column4 graph">
                           ...
                           <div className="dash_blog">
                              <div className="dash_blog_inner">
                                 <div className="dash_head">
                                    <h3><span><i className="fa fa-calendar"></i> 6 July 2018</span><span className="plus_green_bt"><a href="0">+</a></span></h3>
                                 </div>
                                 ...
                                 <div className="task_list_main">
                                    <ul className="task_list">
                                       <li><a href="1">Meeting about plan for Admin Template 2018</a><br/><strong>10:00 AM</strong></li>
                                       <li><a href="1">Create new task for Dashboard</a><br/><strong>10:00 AM</strong></li>
                                       <li><a href="1">Meeting about plan for Admin Template 2018</a><br/><strong>11:00 AM</strong></li>
                                       <li><a href="1">Create new task for Dashboard</a><br/><strong>10:00 AM</strong></li>
                                       <li><a href="1">Meeting about plan for Admin Template 2018</a><br/><strong>02:00 PM</strong></li>
                                    </ul>
                                 </div>
                                 <div className="read_more">
                                    <div className="center"><a className="main_bt read_bt" href="1">Read More</a></div>
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div className="col-md-6">
                           <div className="dash_blog">
                              <div className="dash_blog_inner">
                                 <div className="dash_head">
                                    <h3><span><i className="fa fa-comments-o"></i> Updates</span><span className="plus_green_bt"><a href="1">+</a></span></h3>
                                 </div>
                                 <div className="list_cont">
                                 ...
                                 <div className="msg_list_main">
                                    <ul className="msg_list">
                                       <li>
                                          <span><img src="images/layout_img/msg2.png" className="img-responsive" alt="1" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="images/layout_img/msg3.png" className="img-responsive" alt="1" /></span>
                                          <span>
